...
<div class="container breather">
    <div class="row">
        ...
        <div class="col-md-4 breather">
            ...
            <p><b>Je li tvoj broj mobitela <?php echo $Phone; ?>?</b></p>
            <a class="btn btn-primary" href="/phoneroadblock/request" required>Da. Nastavi na potvrđivanje &rarr;</a>
            <br><small><a href="/preferences">Ne - želim promijeniti broj mobitela.</a></small>
